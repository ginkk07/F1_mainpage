...
│   ├── images/                      # 座位照片（30+ 張）
│   └── svg/                         # SVG 圖形
│       ├── singapore_f1_map.svg     # F1 賽道地圖
│       ├── stage-sidebar-*.svg      # 側邊欄裝飾
│       └── icon_*.svg               # 按鈕圖標
│
├── css/                             # 樣式表
│   ├── main.css                     # 主要樣式（響應式布局）
...
| **圖片路徑** | 座位照片相對路徑 | `./assets/images/grandstand_turn1.png` |
...
turn-1-grandstand,TURN 1 GRANDSTAND,grandstand,ZONE 1,grandstand-turn1,./assets/images/grandstand_turn1.png,絕佳視角的看台座位，可清晰觀看 TURN 1 轉彎。,
turn-1-hospitality,TURN 1 HOSPITALITY,hospitality,ZONE 1,hospitality-turn1,./assets/images/hospitality_turn1.png,高端包廂招待，含飲食服務。,限量
```
